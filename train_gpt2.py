...
for step in range(max_steps):
    ...
    if step % 100 == 0:
        ...
        if master_process:
            ...
            if master_process and step > 0 and (step % 4000 == 0 or last_step):
    ...
    # Every a few steps, evaluate HellaSwag
    ...
    # every a few steps, **generate** from the model (except step 0, which is noise)
